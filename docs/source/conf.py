...
# -*- coding: utf-8 -*-
#
# phollo documentation build configuration file
#
...
version = phollo.__version__
# The full version, including alpha/beta/rc tags.
release = phollo.__release__
...
latex_documents = [
    (master_doc, 'phollo.tex', 'phollo Documentation',
     'iamsteadman', 'manual'),
]
...
man_pages = [
    (master_doc, 'phollo', 'phollo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'phollo', 'phollo Documentation',
     author, 'phollo', 'One line description of project.',
     'Miscellaneous'),
]
