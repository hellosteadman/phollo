...
The source code for the `phollo` project lives at
`github <https://github.com/iamsteadman/phollo>`_.  You can use `git clone` to get it.

.. code-block:: bash

   git clone https://github.com/iamsteadman/phollo
