...
.. moduleauthor:: Mark Steadman <mark@steadman.io>
...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'phollo' / "version.py")
)
...
setup(
    name='phollo',
    description="Follow social media accounts imported from a CSV file",
    ...
    url='https://github.com/iamsteadman/phollo',
    download_url=(
        f'https://github.com/iamsteadman/'
        f'phollo/archive/{version}.tar.gz'
    ),
    keywords=[
